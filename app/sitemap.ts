...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const static_routes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/privacidad`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.3 },
    { url: `${SITE}/terminos`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.3 },
  ]
